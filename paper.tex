...
(indeed, this is the motivation for our entire approach).
...
We now give a formal description of the null-cycle elimination procedure,
...
Another script (\animateevolsayer) can be used to make animations of the evolving RNA structures, using the RNAplot program in the \viennarna\ package \cite{HofackerEtAl94}.
...
in practice a maximum likelihood inference may be adequate (and typically faster).
...
they are flexible and serve our current purposes well.
Our hope is that these algorithms will allow us, and others, to test our
knowledge of RNA evolution by computational reconstruction and (eventually)
