...
important factor for accurate inference of alignment; appropriate use
of posterior-decoding was the next most important factor; and fine
...
inference, so this motivates the use of sum-over-pairs (and
approximate sum-over-pairs) heuristics where possible.  For more exact
