...
We discuss the use of transducer composition for ML (or MCMC) inference on phylogenies,
including possible ways to make these phylogenetic inferences tractable.
