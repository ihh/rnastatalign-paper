...
In all such models, null cycles represent events which are allowed by the model, but could never be observed.
They can be accounted for by exact marginalization.
