...
Since posterior-decoding heuristics can be substantially faster than exact phylogenetic inference,
this motivates the use of sum-over-pairs (and approximate sum-over-pairs) heuristics where possible,
with transducer composition reserved for exact ML (or MCMC) inference on phylogenies.
We discuss possible ways to make these phylogenetic inferences tractable.
