...
An alternative MCMC scheme for sampling RNA phylogeny, structure and alignment was implemented in the SimulFold program \cite{MeyerMiklos2007}.
SimulFold does not use a strictly normalized probabilistic model, and it is unclear how structure and indels interact in the model
