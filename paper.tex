...
\begin{description}
\item{TKF91 ML:} with the TKF91 model \cite{}, the \handel\ package \cite{HolmesBruno2001,Holmes2003,Holmes2007} was used to align the three extant sequences and reconstruct the ancestor.
...
\item{Stemloc AMA:} the \stemloc\ program was used to align the three sequences in AMA mode, using posterior decoding to optimize a sum-over-pairs expected alignment accuracy \cite{BradleyPachterHolmes2008}.
The structures of the leaf sequences were provided, but not the phylogenetic branch lengths.
\end{description}
